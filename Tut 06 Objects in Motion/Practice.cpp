...
//matrix stack class makes matrix operations more efficient
...
public:
	...
	void Translate(const glm::vec3 &offsetVec){
		m_currMat = glm::mat4(::Translate(offsetVec));
	}
...
void display(){
	...
	//glm::mat4 scaleMatrix = Scale(glm::vec3(4.0f, 6.0f, 1.0f));
	//glm::mat4 translateMatrix = Translate(glm::vec3(0.0f, 0.0f, -20.0f));
